...
@Component({
  selector: 'wm-capitalaccount2018',
  templateUrl: './capitalaccount2018.component.html',
  styleUrls: ['./capitalaccount2018.component.scss']
})
export class capitalaccount2018Component extends DatabaseGroup<PostData> {

...
@Component({
  selector: 'wm-distribution2020',
  templateUrl: './distribution2020.component.html',
  styleUrls: ['./distribution2020.component.scss']
})
export class distribution2020Component extends DatabaseGroup<PostData> {

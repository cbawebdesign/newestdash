...
@Component({
  selector: 'wm-capitalcall2018',
  templateUrl: './capitalcall2018.component.html',
  styleUrls: ['./capitalcall2018.component.scss']
})
export class capitalcall2018Component extends DatabaseGroup<PostData> {

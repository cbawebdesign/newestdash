...
@Component({
  selector: 'wm-capitalcall2019',
  templateUrl: './capitalcall2019.component.html',
  styleUrls: ['./capitalcall2019.component.scss']
})
export class capitalcall2019Component extends DatabaseGroup<PostData> {

...
@Component({
  selector: 'wm-newsletterq1',
  templateUrl: './newsletterq1.component.html',
  styleUrls: ['./newsletterq1.component.scss']
})
export class newsletterq1Component extends DatabaseGroup<PostData> {

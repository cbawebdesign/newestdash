...
@Component({
  selector: 'wm-newsletterq4',
  templateUrl: './newsletterq4.component.html',
  styleUrls: ['./newsletterq4.component.scss']
})
export class newsletterq4Component extends DatabaseGroup<PostData> {

...
@Component({
  selector: 'wm-capitalcall2021',
  templateUrl: './capitalcall2021.component.html',
  styleUrls: ['./capitalcall2021.component.scss']
})
export class capitalcall2021Component extends DatabaseGroup<PostData> {

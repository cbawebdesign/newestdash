...
@Component({
  selector: 'wm-capitalaccount2020',
  templateUrl: './capitalaccount2020.component.html',
  styleUrls: ['./capitalaccount2020.component.scss']
})
export class capitalaccount2020Component extends DatabaseGroup<PostData> {

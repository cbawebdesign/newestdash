...
@Component({
  selector: 'wm-capitalcall2020',
  templateUrl: './capitalcall2020.component.html',
  styleUrls: ['./capitalcall2020.component.scss']
})
export class capitalcall2020Component extends DatabaseGroup<PostData> {

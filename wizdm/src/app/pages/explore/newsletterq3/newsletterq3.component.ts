...
@Component({
  selector: 'wm-newsletterq3',
  templateUrl: './newsletterq3.component.html',
  styleUrls: ['./newsletterq3.component.scss']
})
export class newsletterq3Component extends DatabaseGroup<PostData> {

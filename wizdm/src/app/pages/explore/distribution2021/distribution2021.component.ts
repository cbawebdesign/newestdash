...
@Component({
  selector: 'wm-distribution2021',
  templateUrl: './distribution2021.component.html',
  styleUrls: ['./distribution2021.component.scss']
})
export class distribution2021Component extends DatabaseGroup<PostData> {

...
@Component({
  selector: 'wm-capitalcall2017',
  templateUrl: './capitalcall2017.component.html',
  styleUrls: ['./capitalcall2017.component.scss']
})
export class capitalcall2017Component extends DatabaseGroup<PostData> {

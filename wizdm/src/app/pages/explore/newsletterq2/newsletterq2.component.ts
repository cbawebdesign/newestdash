...
@Component({
  selector: 'wm-newsletterq2',
  templateUrl: './newsletterq2.component.html',
  styleUrls: ['./newsletterq2.component.scss']
})
export class newsletterq2Component extends DatabaseGroup<PostData> {

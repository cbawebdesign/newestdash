...
@Component({
  selector: 'wm-distribution2019',
  templateUrl: './distribution2019.component.html',
  styleUrls: ['./distribution2019.component.scss']
})
export class distribution2019Component extends DatabaseGroup<PostData> {

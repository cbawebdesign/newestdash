...
@Component({
  selector: 'wm-capitalaccount2021',
  templateUrl: './capitalaccount2021.component.html',
  styleUrls: ['./capitalaccount2021.component.scss']
})
export class capitalaccount2021Component extends DatabaseGroup<PostData> {

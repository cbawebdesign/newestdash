...
@Component({
  selector: 'wm-distribution2018',
  templateUrl: './distribution2018.component.html',
  styleUrls: ['./distribution2018.component.scss']
})
export class distribution2018Component extends DatabaseGroup<PostData> {
